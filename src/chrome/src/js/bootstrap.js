if (top.document === document) {
    ...
    yepnope([
        ...
        chrome.extension.getURL("lib/js/bower_components/backbone/backbone-min.js"),
        ...
        chrome.extension.getURL("lib/js/bower_components/backbone.localStorage/backbone.localStorage-min.js"),
